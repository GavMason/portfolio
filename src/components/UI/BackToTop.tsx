...
export function BackToTop() {
  ...
  return (
    <button
      ...
      className="fixed bottom-20 right-8 z-90 w-10 h-10 rounded-xl flex items-center justify-center outline-none backdrop-blur-md transition-all duration-400"
      style={{
